		...
		<li><a href="#section-3" class="icon-food"><i class="fa fa-cutlery"></i> <span>CollegeAdmin</span></a></li>
		<li><a href="#section-4" class="icon-lab"><i class="fa fa-flask"></i> <span>Colleges</span></a></li>
