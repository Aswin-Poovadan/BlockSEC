...
<html>
<head>
<title>BlockSec-KTU Login</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="BlockSec-KTU Login" />
				...
				<div class="error_page">
						<!--/login-top-->
							...
							<div class="error-top">
								...
								<div class="login">
									<h3 class="inner-tittle t-inner">KTU Login</h3>
...
<div class="submit"><input type="submit" value="Login" name="admin_signin"></div>
			<div class="clearfix"></div>
				...
				<div class="footer">
						<div class="error-btn">
									<a class="read fourth" href="blocksec.php">Return to Home</a>
									</div>
					<p>&copy 2021 BlockSec . All Rights Reserved </p>
				</div>
			<!--footer section end-->
			<!--/404-->
<!--js -->
