    ...
    <div class="row m-0">
        <div class="col-lg-4 offset-lg-2">
            ...
            <div class="d-flex justify-content-center">
                <form action="/project/faculty/home.php" method="post" enctype="multipart/form-data" id="log-form">

                    <div class="form-row my-4">
                        <div class="col">
                            <input type="username" required name="username" id="username" class="form-control" placeholder="Email*">
                        </div>
                    </div>
